...
봉지는 3킬로그램 봉지와 5킬로그램 봉지가 있다. 상근이는 귀찮기 때문에, 최대한 적은 봉지를 들고 가려고 한다. 예를 들어, 18킬로그램 설탕을 배달해야 할 때, 
...
N = int(input('상근이가 배달해야하는 설탕의 kg을 입력하세요 : '))
count = 0
while(1) :
    if(N%5 == 0) :
        count += N/5
        print('설탕봉지의 최소 개수는 ',int(count),"개 이다.")
        break
